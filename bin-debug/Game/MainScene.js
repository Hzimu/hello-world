...
var MainScene = (function (_super) {
    ...
    MainScene.prototype.upInitUI = function () {
        this.Group_mbtn.touchEnabled = true;
        this.Group_mbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onGroupClick, this);
    };
    MainScene.prototype.onGroupClick = function (egret) {
        // 如果target有子元素,说明点到的是Group,而不是里面的按钮
        if (egret.target.numElements) {
            return;
        }
        var theBtn = egret.target;
